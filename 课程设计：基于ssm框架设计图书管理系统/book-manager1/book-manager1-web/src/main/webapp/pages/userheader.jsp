...
<div class="container-fluid">
	<div class="col-md-8" >
		<font size="7"><strong>G D U T 图 书 管 理 系 统</strong></font>
	</div>
	<div class="col-md-4" style="padding-top:20px">
		<ol class="list-inline">
			<li><a href="/pages/login.jsp">登录</a></li>
			<li><a href="/pages/register.jsp">注册</a></li>
			<li><a href="${pageContext.request.contextPath}/borrowitem">  借阅记录</a></li>
		</ol>
	</div>
</div>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/pages/index.jsp">首页</a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav" id="categoryUl">
					<c:forEach items="${categoryList }" var="category">
					<li><a href="/findbook?cid=${category.cid }">${category.cname }</a></li>
					</c:forEach>
